    ...
    switch ($action) {
        case 'add':
            if (isset($_POST['last_name'], $_POST['first_name'], $_FILES['photo'])) {
                ...
                $response = $director->add(htmlspecialchars($_POST['last_name']), htmlspecialchars($_POST['first_name']), $new_filename);
        ...
        case 'update':
            if (isset($_POST['id'], $_POST['last_name'], $_POST['first_name'], $_POST['photo'])) {
                $response = $director->update(htmlspecialchars($_POST['id']), htmlspecialchars($_POST['last_name']), $_POST['first_name'], htmlspecialchars($_POST['photo']));
            } else {
        ...
        case 'delete':
            if (isset($_POST['id'])) {
                $response = $director->delete($_POST['id']);
            } else {
